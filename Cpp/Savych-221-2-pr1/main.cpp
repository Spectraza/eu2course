...
//
//3. Програму створити в трьох файлах: заготовочний файл *.h з описом класу, файл з функціями класу *.cpp, та головна функція main.cpp. Доступ
//        до полів класу виконати через методи класу.
